...
int main(void)
{
	...
	unsigned char tempAH = 0x00; //Temporary variable to hold the value of High nibble of A
	...
	tempAH = PINA & 0xF0; //Read High nibble Input From A
	...
	if(tempAH ==0x30){ // car is on, drivers seat is pressed, seatbelt is not on 
